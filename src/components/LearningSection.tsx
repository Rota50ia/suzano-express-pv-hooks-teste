        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="mt-16 text-center space-y-8">
            ...
            <div className="mt-12 max-w-2xl mx-auto">
              <div className="text-primary-foreground p-6 rounded-lg text-center mb-8 bg-blue-500">
              ...
              <div className="text-center mt-8">
                <a href="https://sun.eduzz.com/50027?utm_source=suzano+express&utm_id=pvtestehooks" className="bg-orange-500 hover:bg-orange-600 text-white border-none py-5 px-10 text-lg rounded-lg cursor-pointer font-bold transition-colors inline-block">
