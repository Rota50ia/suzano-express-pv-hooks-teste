        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center">
            <div className="border-2 border-yellow-200 p-5 rounded-lg my-5 max-w-4xl mx-auto bg-amber-500">
              ...
              <p className="m-0 text-slate-950 text-xl">
                Se você não tocar sua primeira música completa, envie um e-mail para <strong>suzanoexpresspandeiro@gmail.com</strong> e devolvemos 100% do seu dinheiro - <strong>sem perguntas, sem complicação.</strong>
              </p>
            </div>
          </div>
        </div>
